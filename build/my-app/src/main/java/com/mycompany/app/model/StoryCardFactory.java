    ...
    public static StoryCard createCard(Types type){
        switch (type){
            ...
            case TEST_OF_THE_GREEN_KNIGHT:
                return defaultQuest(33, "/Q Test of the Green Knight.jpg", "Test of the Green Knight", 4);
            case SEARCH_FOR_THE_QUESTING_BEAST:
                return defaultQuest(34, "/Q Search for the Questing Beast.jpg", "Search for the Questing Beast", 4);
            case DEFEND_THE_QUEENS_HONOR:
                return defaultQuest(35, "/Q Defend the Queen's Honor.jpg", "Defend the Queen's Honor", 4);
            case RESCUE_THE_FAIR_MAIDEN:
                return defaultQuest(36, "/Q Rescue the Fair Maiden.jpg", "Rescue the Fair Maiden", 3);
            case JOURNEY_THROUGH_THE_ENCHANTED_FOREST:
                return defaultQuest(37, "/Q Journey through the Enchanted Forest.jpg", "Journey through the Enchanted Forest", 3);
            case VANQUISH_KING_ARTHURS_ENEMIES:
                return defaultQuest(38, "/Q Vanquish King Arthur's Enemies.jpg", "Vanquish King Arthur's Enemies", 3);
            case SLAY_THE_DRAGON:
                return defaultQuest(39, "/Q Slay the Dragon.jpg", "Slay the Dragon", 3);
            case BOAR_HUNT:
                return defaultQuest(40, "/Q Boar Hunt.jpg", "Boar Hunt", 2);
            case REPEL_THE_SAXON_RAIDERS:
                return defaultQuest(41, "/Q Repel the Saxon Raiders.jpg", "Repel the Saxon Raiders", 2);
            case TOURNAMENT_AT_CAMELOT:
                return defaultTournament(42, "/QT Camelot.jpg", "Tournament at Camelot", 3);
            case TOURNAMENT_AT_ORKNEY:
                return defaultTournament(43, "/QT Orkney.jpg", "Tournament at Orkney", 2);
            case TOURNAMENT_AT_TINTAGEL:
                return defaultTournament(44, "/QT Tintagel.jpg", "Tournament at Tintagel", 1);
            case TOURNAMENT_AT_YORK:
                return defaultTournament(45, "/QT York.jpg", "Tournament at York", 0);
            case KINGS_RECOGNITION:
                return defaultEvent(46, "/E King's Recognition.jpg", "King's Recognition", 0);
            case QUEENS_FAVOR:
                return defaultEvent(47, "/E Queen's Favor.jpg", "Queen's Favor", 0);
            case COURT_CALLED_TO_CAMELOT:
                return defaultEvent(48, "/E Court Called Camelot.jpg", "Court Called to Camelot", 0);
            case POX:
                return defaultEvent(49, "/E Pox.jpg", "Pox", 0);
            case PLAGUE:
                return defaultEvent(50, "/E Plague.jpg", "Plague", 0);
            case CHIVALROUS_DEED:
                return defaultEvent(51, "/E Chivalrous Deed.jpg", "Chivalrous Deed", 0);
            case PROSPERITY_THROUGHOUT_THE_REALM:
                return defaultEvent(52, "/E Prosperity Throughout the Realm.jpg", "Prosperity Throughout the Realm", 0);
            case KINGS_CALL_TO_ARMS:
                return defaultEvent(53, "/E King's Call to Arms.jpg", "King's Call to Arms", 0);
        }
        return null;
    }
